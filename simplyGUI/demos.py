...
def manyCalendars():
    ...
    layout = [
        ...
        [sg.Input(key='-IN-', size=(20,1)),
         sg.CalendarButton('Cal US No Buttons Location (100,100)',
                           close_when_date_chosen=True,
                           target='-IN-',
                           location=(100,100), no_titlebar=False,
                           )
         ],
          [sg.Input(key='-IN3-', size=(20,1)),
           sg.CalendarButton('Cal Monday',
                             title='Pick a date any date',
                             no_titlebar=True,
                             close_when_date_chosen=False,
                             target='-IN3-',
                             begin_at_sunday_plus=1,
                             month_names=('студзень',
                                          'люты',
                                          'сакавік',
                                          'красавік',
                                          'май',
          ...
          [sg.Input(key='-IN2-', size=(20,1)),
           sg.CalendarButton('Cal German Feb 2020',
                             target='-IN2-',
                             default_date_m_d_y=(2,None,2020),
                             locale='de_DE',
                             begin_at_sunday_plus=1
                             )
           ],
          [sg.Input(key='-IN4-', size=(20,1)),
           sg.CalendarButton('Cal Format %m-%d Jan 2020',
                             target='-IN4-',
                             format='%m-%d',
